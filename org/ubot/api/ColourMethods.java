...
import org.ubot.api.methods.Bank;
import org.ubot.api.methods.Camera;
import org.ubot.api.methods.GrandExchange;
import org.ubot.api.methods.GroundItem;
import org.ubot.api.methods.Menu;
import org.ubot.api.methods.Minimap;
import org.ubot.api.methods.Npc;
import org.ubot.api.methods.Player;
import org.ubot.api.methods.Players;
import org.ubot.api.methods.TabContainer;
import org.ubot.api.methods.Walker;
import org.ubot.api.utils.Image;
import org.ubot.api.utils.Points;
import org.ubot.api.wrappers.OCR;
import org.ubot.api.wrappers.TheKeyboard;
import org.ubot.api.wrappers.TheMouse;
...
public class ColourMethods {
	...
	/**
	 * To pause your script.
	 */
	public void pauseScript(boolean pause){
		try{
			captureScreenWithPaint();
		}catch (InterruptedException e){e.printStackTrace();}
 ...
 *****************************************************************************************/
	...
	/**
	 * This will reload the client.
	 * Do not call this it will only work for the random.
	 * 
	 * @throws InterruptedException
	 */
	public void reload6HourLimit() throws InterruptedException{
		try {
			client.loadScapegoat();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
